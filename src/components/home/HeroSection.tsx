...
export function HeroSection({
  ...
  return (
    <section className="relative overflow-hidden border-b border-border bg-surface min-h-[480px] lg:min-h-[520px] flex items-center">
      {/* Blended Animated Technical/Laboratory Background Image */}
      <div
        className="absolute inset-0 bg-cover bg-center opacity-[0.24] dark:opacity-[0.16] animate-kenburns pointer-events-none transition-all duration-700"
      ...
      {/* Floating premium gradient glowing nodes */}
      <div className="absolute top-1/4 right-1/4 w-80 h-80 rounded-full bg-blue/15 dark:bg-blue/10 blur-[90px] animate-pulse-slow pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/3 w-[400px] h-[400px] rounded-full bg-orange/8 dark:bg-orange/4 blur-[110px] animate-pulse-slow pointer-events-none" />
      ...
      <BisLogo className="pointer-events-none absolute -right-16 -bottom-10 h-80 w-80 opacity-[0.03] dark:opacity-[0.02] animate-rotate" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1380px] px-6 py-14 lg:py-16">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_360px] lg:gap-12 items-center">
          <div>
            ...
            <div className="mt-8 max-w-2xl transform transition-transform duration-300 hover:scale-[1.005]">
              <SearchHero onSubmit={onSubmit} loading={loading} />
            </div>
          </div>

          <div className="lg:pt-1 animate-float">
            <TrustCard />
          </div>
        </div>
      </div>
