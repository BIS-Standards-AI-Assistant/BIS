...
export function ShieldCheckIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.6} stroke="currentColor" aria-hidden="true" {...props}>
      <path d="M12 3l7 3v6c0 4.6-3 7.6-7 9-4-1.4-7-4.4-7-9V6l7-3Z" strokeLinejoin="round" />
...
export function ExternalLinkIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.8} stroke="currentColor" aria-hidden="true" {...props}>
      <path d="M9 6H6a1.5 1.5 0 0 0-1.5 1.5v10A1.5 1.5 0 0 0 6 19h10a1.5 1.5 0 0 0 1.5-1.5V15M14 5h5v5M18.5 5.5 11 13" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function BadgeCheckIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.6} stroke="currentColor" aria-hidden="true" {...props}>
      <path d="M12 3.5 14.2 5l3-.3.7 3 2.3 2-1.4 2.8 1.4 2.8-2.3 2-.7 3-3-.3L12 22.5 9.8 21l-3 .3-.7-3-2.3-2 1.4-2.8L3.8 9.7l2.3-2 .7-3 3 .3L12 3.5Z" strokeLinejoin="round" />
      <path d="m9 12.3 2 2 4-4.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function FlaskIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.6} stroke="currentColor" aria-hidden="true" {...props}>
      <path d="M10 3.5h4M10 3.5v6l-5.2 8.6a1.5 1.5 0 0 0 1.3 2.4h11.8a1.5 1.5 0 0 0 1.3-2.4L14 9.5v-6" strokeLinecap="round" strokeLinejoin="round" />
...
export function CompareIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.6} stroke="currentColor" aria-hidden="true" {...props}>
      ...
      <path d="M4 9l-1.5 2L4 13M20 9l1.5 2L20 13" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function BalanceIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.6} stroke="currentColor" aria-hidden="true" {...props}>
      ...
      <path d="M12 6 5 8M12 6l7 2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M5 8 2.5 13a2.7 2.7 0 0 0 5 0L5 8ZM19 8l-2.5 5a2.7 2.7 0 0 0 5 0L19 8Z" strokeLinejoin="round" />
    </svg>
  );
}
...
export function AccessibilityIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.6} stroke="currentColor" aria-hidden="true" {...props}>
      ...
      <path d="M5 8.5c3.5 1 10.5 1 14 0M12 8v13M9 21l3-6 3 6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
